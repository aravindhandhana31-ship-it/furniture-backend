...
import com.ecommerce.furniture.payload.response.JwtResponse;
import com.ecommerce.furniture.payload.response.MessageResponse;
...
public class AuthController {
  ...
  public ResponseEntity<?> authenticateUser(@Valid @RequestBody LoginRequest loginRequest) {
    ...
    return ResponseEntity.ok(new JwtResponse(jwt,
                         userDetails.getId(),
                         userDetails.getName(), // username is email in UserDetailsImpl
